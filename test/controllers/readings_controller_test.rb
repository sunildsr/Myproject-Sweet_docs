...
class ReadingsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create reading" do
    assert_difference('Reading.count') do
      post readings_url, params: { reading: { glucose_reading: @reading.glucose_reading, integer: @reading.integer } }
    end
  ...
  test "should update reading" do
    patch reading_url(@reading), params: { reading: { glucose_reading: @reading.glucose_reading, integer: @reading.integer } }
